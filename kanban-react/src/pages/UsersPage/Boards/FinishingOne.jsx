...
const FinishingOne = () => {
    ...
    const DoneForm = {
        ...
        date_checked: "",
        finishing_one: "Ok",
        date_finished_one: defaultTimeValue,
        finishing_two: "",
        date_started: "",
        date_finished: ""
    }
    ...
    const handleDoProcess = async (e, order_id) => {
        ...
        if(response.data.status === 200){
            ...
            closeProgResult();
            navigate("/dashboard/finishing_one");
        }
      };
    ...
    <div className='py-5 md:px-12'>
            ...
            <div className="h-full overflow-y-auto">
                ...
                <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div>
                        ...
                        {product_orders?.filter(product_order => product_order.finishing_one === null  && product_order.quality_control === "Ok").length}
                        </p>
                    </div>
                    </div>
                    <div className="flex items-center p-4 rounded-lg shadow-xs bg-gray-800">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-semibold text-gray-200">
                        {product_orders?.filter(product_order => product_order.finishing_one === "In-Progress" && product_order.quality_control === "Ok").length}
                        </p>
                    </div>
                    </div>
                    <div className="flex items-center p-4 rounded-lg shadow-xs bg-gray-800">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-semibold text-gray-200">
                        {product_orders?.filter(product_order => product_order.date_finished_one !== null && product_order.date_checked !==null).length}
                        </p>
                    </div>
                    </div>
                </div>
        ...
        <div className='px-4 gap-6 flex w-full flex-wrap lg:flex-nowrap'>
                ...
                <div className='flex flex-col gap-4 max-h-[60vh] overflow-y-scroll'>
                    {
                        ...
                        product_orders?.filter(product_order => (product_order.finishing_one === null && product_order.quality_control === "Ok")).map(order => {
                            return(
            ...
            <div className="py-8 w-full lg:w-1/3">
                ...
                <div className='flex flex-col gap-4 max-h-[60vh] overflow-y-scroll'>
                    {
                        product_orders?.filter(product_order => product_order.finishing_one === "In-Progress"  && product_order.quality_control === "Ok").length > 0 ?
                        
                            product_orders?.filter(product_order => (product_order.finishing_one === "In-Progress"  && product_order.quality_control === "Ok")).map(order => {
                                return(
            ...
            <div className="py-8 w-full lg:w-1/3">
                ...
                <div className='flex flex-col gap-4 max-h-[60vh] overflow-y-scroll'>
                    {
                        product_orders?.filter(product_order => (product_order.finishing_one === "Ok"  && product_order.quality_control === "Ok")).map(order => {
                            return(
