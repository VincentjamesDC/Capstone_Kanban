...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('assembly_prep_finish')->nullable();
            $table->string('assembly_one')->nullable();
            $table->string('assembly_one_finish')->nullable();
            $table->string('assembly_two')->nullable();
            $table->string('assembly_two_finish')->nullable();
            $table->string('quality_control')->nullable();
            $table->string('quality_control_finish')->nullable();
            $table->string('finishing_one')->nullable();
            $table->string('finishing_one_finish')->nullable();
            $table->string('finishing_two')->nullable();
            $table->string('finishing_two_finish')->nullable();
